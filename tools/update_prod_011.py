...
pkg_data = {
    ...
    "standard_skeleton_25_30s": "Chunk 1: Pure Viral Hook (0-6s) | Chunk 2: Action / Application (6-10s) | Chunk 3: Mechanism Reframe (10-15s) | Chunk 4: Mechanism Deep-Dive (15-20s) | Chunk 5: Payoff & Contrast (20-25s) | Chunk 6: Hard CTA (25-30s)",
    "chunks": [
        {
            "chunk_id": 1,
            "beat_name": "Pure Viral Hook",
            "recommended_duration_s": 6,
            "word_count": 21,
            "voiceover_clean_tts": "I know this looks absolutely insane, but pour a glass bottle of Coca-Cola right onto that thin middle part and watch what happens.",
            "visual_direction": "Rachel stands in her luxury salon holding a vintage glass Coca-Cola bottle near her middle part line, looking at the camera with intense, confident intrigue.",
            "composition_audit": {
                ...
                "left_subject": {
                    ...
                    "pose": "Right hand holding classic glass Coca-Cola bottle near crown area, left hand pointing directly at hair part line",
                    "hands_interaction": "Holding glass bottle upright near middle part",
                    "gaze_direction": "Looking directly into camera lens with confident and high-retention scroll-stopping gaze",
            ...
            "midjourney_prompt_9_16": "Vertical 9:16 portrait photograph of a beautiful 47-year-old female salon owner with layered collarbone-length wavy bob hair and platinum highlights, wearing a crisp white silk blouse under a premium black canvas apron with elegant gold embroidery 'Bennett Studio' on the chest, holding a vintage glass Coca-Cola bottle near her middle hair parting, luxury salon interior background with fluted walnut vanities and glowing warm arched mirrors, soft studio vanity lighting, cinematic photorealism, shot on 35mm f/1.8 --ar 9:16 --v 6.1 --style raw",
            "video_motion_prompt_i2v": "Medium close-up of Rachel speaking directly to the camera with high-energy facial animation, holding a glass Coca-Cola bottle up and pointing smoothly to her hair part, intense eye contact, conversational hand movement, 4k ultra realistic motion",
            "asset_tags": ["rachel_bennett", "hook", "coke_bottle", "luxury_salon", "bennett_studio"],
            "continuity_notes": "Exact 1:1 viral hook pacing and phrasing for maximum scroll-stop retention."
        },
        {
            "chunk_id": 2,
            "beat_name": "Action / Application",
            "recommended_duration_s": 4,
            "word_count": 18,
            "voiceover_clean_tts": "Work it from the roots all the way down to the tips. Let it sit ten minutes, then rinse it out.",
            "visual_direction": "Rachel demonstrates the massage and application with fingertips at the scalp at her vanity station, confident instructional delivery.",
            "composition_audit": {
                ...
                "left_subject": {
                    ...
                    "pose": "Both hands gently working through hair roots and down through ends",
                    "hands_interaction": "Fingertips massaging scalp and working down hair shaft",
            ...
            "video_motion_prompt_i2v": "Rachel speaking conversationally while lightly massaging her fingertips through her roots, smiling warmly at camera, natural fluid arm motion, realistic lip sync",
        ...
        },
        {
            ...
            "word_count": 12,
            "voiceover_clean_tts": "You're about to throw away every expensive product sitting on your bathroom shelf.",
            "visual_direction": "Rachel leans slightly on the vanity counter, gesturing with one hand toward luxury products on display with a knowing, confident smile.",
            "composition_audit": {
                ...
                "left_subject": {
                    ...
                    "pose": "Gesturing emphatically with right hand toward background shelf, direct gaze",
                    "hands_interaction": "Open hand gesture dismissing overpriced products",
            ...
            "midjourney_prompt_9_16": "Vertical 9:16 portrait of a 47yo chic female salon owner with platinum wavy bob, white silk blouse and black apron with gold 'Bennett Studio' lettering, gesturing knowingly with one hand towards a salon shelf, luxury salon display background with warm golden backlighting, sharp photorealistic detail --ar 9:16 --v 6.1 --style raw",
            "video_motion_prompt_i2v": "Rachel explaining with authoritative hand gesture, slight head shake, clear articulate speech, smooth natural body movement, high definition realistic video",
        ...
        },
        {
            ...
            "recommended_duration_s": 5,
            "word_count": 19,
            "voiceover_clean_tts": "The phosphoric acid in Coke literally strips away every bit of buildup that's been suffocating your follicles for months.",
            "visual_direction": "Rachel gently touches her crown, showing the root lift and clean scalp while explaining the phosphoric acid mechanism.",
            "composition_audit": {
                ...
                "left_subject": {
                    ...
                    "pose": "One hand lifting a section of hair at the crown to illustrate unclogged roots",
                    "hands_interaction": "Touching hair near parting line with delicate professional touch",
                    "gaze_direction": "Looking into camera with serious, informative expert expression",
                    "outfit": "Crisp white silk blouse under black canvas stylist apron with 'Bennett Studio' in gold cursive"
                },
                "right_subject": None,
        ...
        },
        {
            ...
            "recommended_duration_s": 5,
            "word_count": 19,
            "voiceover_clean_tts": "You're dropping forty dollars on a clarifying shampoo when a bottle of Coke does it way better for two bucks.",
            "visual_direction": "Rachel smiles broadly with open palms in a rhetorical comparison, radiant hair bouncing softly in the warm salon light.",
            "composition_audit": {
                "camera_shot_type": "Vertical 9:16 medium shot, eye level, 35mm lens",
        ...
        },
        {
            ...
            "recommended_duration_s": 5,
            "word_count": 16,
            "voiceover_clean_tts": "Comment HAIR below and I'll send you my complete scalp reset protocol right away!",
...
## 6-Chunk Production Prompts (High-Retention Viral Architecture)
...
print("Updated PROD_011 package and markdown successfully!")
